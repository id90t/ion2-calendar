...
function MonthComponent_ng_template_2_ng_template_1_ng_container_1_small_5_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const day_r13 = i0.ɵɵnextContext(2).$implicit;
        i0.ɵɵadvance(1);
        i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction3(1, _c0$3, day_r13.demandLevel === "Low", day_r13.demandLevel === "Medium", day_r13.demandLevel === "High"));
    }
}
function MonthComponent_ng_template_2_ng_template_1_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
        ...
        i0.ɵɵelementContainerStart(0);
        i0.ɵɵelementStart(1, "button", 6);
        i0.ɵɵlistener("click", function MonthComponent_ng_template_2_ng_template_1_ng_container_1_Template_button_click_1_listener() { i0.ɵɵrestoreView(_r21); const day_r13 = i0.ɵɵnextContext().$implicit; const ctx_r19 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r19.onSelected(day_r13)); });
        i0.ɵɵelementStart(2, "p");
        i0.ɵɵtext(3);
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(4, MonthComponent_ng_template_2_ng_template_1_ng_container_1_small_4_Template, 2, 1, "small", 5);
        i0.ɵɵtemplate(5, MonthComponent_ng_template_2_ng_template_1_ng_container_1_small_5_Template, 2, 5, "small", 7);
        i0.ɵɵelementEnd();
        i0.ɵɵelementContainerEnd();
    }
    if (rf & 2) {
        ...
        i0.ɵɵadvance(1);
        i0.ɵɵproperty("ngIf", day_r13.demandLevel);
    }
}
...
function CalendarDemandModal_ion_row_9_ng_template_10_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_ion_row_9_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_ion_calendar_week_10_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_div_12_ng_template_2_Template(rf, ctx) {
    if (rf & 1) {
        const _r14 = i0.ɵɵgetCurrentView();
...
function CalendarDemandModal_div_12_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_div_13_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_ion_row_17_Template(rf, ctx) {
    if (rf & 1) {
...
function CalendarDemandModal_ion_button_18_span_1_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementStart(0, "span");
        i0.ɵɵtext(1);
        i0.ɵɵelementEnd();
...
function CalendarDemandModal_ion_button_18_ion_icon_2_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelement(0, "ion-icon", 35);
    }
}
function CalendarDemandModal_ion_button_18_Template(rf, ctx) {
    if (rf & 1) {
...
class CalendarDemandModal {
    ...
    initDemandCalendar() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.initDefaultDate();
            this.findCssClass();
            if ((_a = this._d) === null || _a === void 0 ? void 0 : _a.canBackwardsSelected) {
                this.backwardsMonth();
            }
            this.scrollToDefaultDate();
        });
    ...
    scrollToDate(date) {
        var _a;
        const defaultDateIndex = this.findInitMonthNumber(date);
        const monthElement = (_a = this.monthsEle) === null || _a === void 0 ? void 0 : _a.nativeElement.children[`month-${defaultDateIndex}`];
        const domElemReadyWaitTime = 300;
        setTimeout(() => {
            const defaultDateMonth = monthElement ? monthElement.offsetTop : 0;
            if (defaultDateIndex !== -1 && defaultDateMonth !== 0) {
    ...
    repaintDOM() {
        return this.content.getScrollElement().then((scrollElem) => {
            ...
            scrollElem.style.zIndex = '2';
            scrollElem.style.zIndex = 'initial';
            if ((_a = this.monthsEle) === null || _a === void 0 ? void 0 : _a.nativeElement) {
                this.monthsEle.nativeElement.style.zIndex = '2';
                this.monthsEle.nativeElement.style.zIndex = 'initial';
            }
        });
