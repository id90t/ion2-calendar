...
function MonthComponent_ng_template_1_ng_template_1_ng_container_1_small_6_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MonthComponent, [{
        type: Component,
