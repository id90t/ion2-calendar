...
class ModuleTypeTranslator {
    ...
    newTypeTranslator(context) {
        ...
        const translator = new typeTranslator.TypeTranslator(this.host, this.typeChecker, translationContext, this.host.unknownTypesPaths || new Set(), this.symbolsToAliasedNames, this.symbolToNameCache, (sym) => this.ensureSymbolDeclared(sym));
